    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
            color: sendByYou ? const Color(0xff2a63e2) : const Color(0xff2c2c2c),
                ...
                bottomLeft: sendByYou
                    ...
                    : !isFirst && !isLast
                        ...
                        : isLast
                            ? const Radius.circular(20)
                            : const Radius.circular(0),
                topRight: !sendByYou ? const Radius.circular(20) : const Radius.circular(20),
                bottomRight: !sendByYou ? const Radius.circular(20) : const Radius.circular(0))),
        child: Padding(
